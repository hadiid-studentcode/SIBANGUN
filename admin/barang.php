...
$data = mysqli_query($conn, "SELECT * FROM barang JOIN barang_masuk ON barang.kode_barang_masuk = barang_masuk.kode_barang_masuk");
                               ...
                               <tbody>
                                   <tr scope="row">
                                       ...
                                       <td class="align-middle text-center">
                                           <span class="text-secondary text-xs font-weight-bold"><?= $barang["jenis_barang"]; ?></span>
                                       </td>
                                       <td class="align-middle text-center">
