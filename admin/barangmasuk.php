 ...
 $masuk = mysqli_query($conn, "SELECT * FROM barang_masuk JOIN user ON barang_masuk.id_user = user.id_user");
                       ...
                       <table class="table align-items-center mb-0">
                           ...
                           <?php while ($barangMasuk = mysqli_fetch_array($masuk)) : ?>
                               <tbody>
                                   ...
                                   <td class="align-middle text-center">
                                       <span class="text-secondary text-xs font-weight-bold"><?= $barangMasuk["id_suplier"]; ?></span>
                                   </td>
                                   <td class="align-middle text-center">
